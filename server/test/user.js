...
describe('User Test', function(){
    ...
    describe('Test Route /user/signup', function(){
        it('Success signup with status code 201', function(done){
            chai.request(app)
                .post('/user/signup')
                .send(user)
